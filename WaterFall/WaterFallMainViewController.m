...
#import "WaterFallMainViewController.h"
...
@interface WaterFallMainViewController ()<UICollectionViewDataSource,DUWaterFallLayoutDelegate>
/** 所有的商品数据 */
...
@implementation WaterFallMainViewController
...
- (void)loadNewShops
{
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        NSArray *shops = [ZXRShop mj_objectArrayWithFilename:@"1.plist"];
...
{
    // 创建布局
    DUWaterFallLayout *layout = [[DUWaterFallLayout alloc] init];
...
#pragma mark - <DUWaterflowLayoutDelegate>
